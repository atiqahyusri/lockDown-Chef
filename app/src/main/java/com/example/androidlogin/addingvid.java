...
public class addingvid extends AppCompatActivity {

    private static final int PICK_VIDEO_REQUEST = 1;

    //declaration for choose button to add video, upload button, progress bar, video view,video name, and related database
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addingvid);

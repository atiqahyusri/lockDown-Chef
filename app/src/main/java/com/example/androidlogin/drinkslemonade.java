...
public class drinkslemonade extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_drinkslemonade);
        ...
        servingnum.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                bahan2.setText(String.valueOf(serve*1));
                bahan3.setText(String.valueOf(serve*1));
                bahan4.setText(String.valueOf(serve*2));
            }
